...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[130vh] md:h-[180vh]  flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[.55] sm:scale-[.7]"
    >
      <motion.h2
        style={{
        ...
        className="dark:text-white text-neutral-800 text-8xl font-bold mt-[-14rem] mb-20 text-center"
      >
        <span className="bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-zinc-600 bg-opacity-50">
          {title}
        </span>
      </motion.h2>
      {/* Lid */}
